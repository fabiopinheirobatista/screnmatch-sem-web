package br.com.fabio.screenmatch.principal;
...
import br.com.fabio.screenmatch.model.Episodio;
...
public class Principal {
    ...
    public void exibeMenu(){
        System.out.println("Digite o nome da série para que a busca seja realizada: ");
        ...
        /*List<String> nomes = Arrays.asList("Fabio", "Vanessa", "Giovanna", "Lívia", "Thor", "Apolo", "Sky");
        nomes.stream()
                .sorted()
                .limit(3)
